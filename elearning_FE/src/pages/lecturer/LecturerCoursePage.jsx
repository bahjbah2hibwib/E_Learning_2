...
const StatCard = ({ icon, iconBg, iconColor, title, value }) => (
  <Card
    bordered={false}
    style={{ borderRadius: "12px", boxShadow: "0 2px 10px rgba(0,0,0,0.02)" }}
...
const LecturerCoursePage = () => {
    ...
    try {
      ...
      if (res && res.success) {
        setStats({
          ...
          pending: (res.data.totalCourses || 0) - (res.data.activeCourses || 0),
        });
      }
    } catch (e) {
      console.error(e);
    ...
    try {
      ...
      message.error(
        error.response?.data?.message ||
          "Không thể xóa khóa học. Vui lòng chuyển sang Đã ẩn.",
      );
    } finally {
      setIsSubmitting(false);
    }
  ...
  const renderStatusTag = (status) => {
    ...
    if (status === "PENDING")
      return (
        <Tag color="warning" style={{ borderRadius: "12px" }}>
          Chờ duyệt
        </Tag>
      );
    if (status === "HIDDEN")
              ...
              {!selectedCourse && !isCreating && courses.length === 0 ? (
                  ...
                  <Empty
                    ...
                    description={
                      <span style={{ color: "#64748b", fontSize: "16px" }}>
                        Bạn chưa có khóa học nào. Hãy bắt đầu bằng cách tạo mới!
                      </span>
                    }
                  >
                    <Button
                ...
                >
                  <Text type="secondary" style={{ fontSize: "16px" }}>
                    Vui lòng chọn một khóa học ở danh sách bên trái hoặc tạo
                    mới.
                  </Text>
                </div>
              ) : (
                <>
                  <Tabs
                    ...
                    items={[
                        ...
                        children: (
                          <div style={{ padding: "24px" }}>
                            ...
                            >
                              <Form.Item
                                label={
                                  <Text strong>Ảnh đại diện (Thumbnail)</Text>
                                }
                              >
                                <div
                                  style={{
                              ...
                              <Row gutter={16}>
                                <Col span={12}>
                                  <Form.Item
                                    label={<Text strong>Loại khóa học</Text>}
                                    name="type"
                                  >
                                    <Select size="large">
                                      <Option value="free">
                      ...
                      },
                      {
                        ...
                        children: <CourseFilesTab courseData={courseDetail} />,
                      },
                      {
                        key: "4",
                        label: (
                  ...
                  >
                    ...
                    <Space>
                      ...
                      {/* ✅ Sửa: dùng form.submit() thay vì getElementById */}
                      <Button
                        type="primary"
                        size="large"
