          ...
          <Col xs={24} lg={17}>
            ...
            <div>
              ...
              {selectedLesson.quizzes && selectedLesson.quizzes.length > 0 ? (
                selectedLesson.quizzes.map((quiz, idx) => (
                  <div
                    key={idx}
                    style={{
                      background: "#fff",
                  ...
                  >
                    <Title
                      level={5}
                      style={{ color: "#334155", marginBottom: "24px" }}
                    >
                      {quiz.title}
                    </Title>
                    {quiz.questions &&
                      quiz.questions.map((question, qIdx) => (
                        <div
                          ...
                          style={{
                            marginBottom:
                              qIdx === quiz.questions.length - 1 ? 0 : "32px",
                          }}
                        >
                          <div
                            style={{
                ...
                >
                  <Empty
                    ...
                    description="Bài học này chưa có bài tập trắc nghiệm"
                  />
                </div>
              )}
            </div>
          ...
          <Col xs={24} lg={7}>
            <div style={{ position: "sticky", top: "0" }}>
              ...
              >
                ...
                >
                  <FolderOpenOutlined style={{ color: "#3b82f6" }} /> Tài nguyên
                  bài học
                </Title>
                      ...
                      return (
                        <List.Item
                          style={{
                            ...
                            borderRadius: "8px",
                            marginBottom:
                              idx === selectedLesson.documents.length - 1
                                ? 0
                                : "12px",
                            border: "1px solid #e2e8f0",
                            transition: "all 0.2s",
                          ...
                          <List.Item.Meta
                            ...
                            title={
                              <Text
                                ...
                                ellipsis={{
                                  tooltip: doc.fileName || doc.title,
                                }}
                              >
              ...
              <div style={{ padding: "0 8px" }}>
                ...
                >
                  ...
                  >
                    ...
                    <Tag
                      color={selectedLesson.isFreePreview ? "green" : "blue"}
                      style={{
                        margin: 0,
                        borderRadius: "4px",
                        fontWeight: 500,
                  ...
                  >
                    ...
                    <Text strong style={{ color: "#334155" }}>
                      {selectedLesson.duration || 0} phút
                    </Text>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <Text strong style={{ color: "#334155" }}>
                      {selectedLesson.quizzes?.length || 0} bài
                    </Text>
                  </div>
                </Space>
              </div>
                  ...
                  <List.Item.Meta
                    ...
                    title={
                      ...
                      >
                        ...
                        <Tag
                          color={lesson.isFreePreview ? "green" : "default"}
                          style={{
                            margin: 0,
                            borderRadius: "12px",
                            padding: "2px 10px",
                    ...
                    description={
                      <Space size="middle" style={{ marginTop: "4px" }}>
                        ...
                        >
                          ...
                          {lesson.documentCount || 0} Tài liệu
                        </Space>
                        <Space
                          size={4}
                          style={{ color: "#64748b", fontSize: "12px" }}
                        >
                          <FormOutlined style={{ color: "#10b981" }} />{" "}
                          {lesson.quizCount || 0} Bài tập
                        </Space>
                      </Space>
                    }
                  />
