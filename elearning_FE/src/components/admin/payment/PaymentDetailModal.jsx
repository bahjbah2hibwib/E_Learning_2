    ...
    >
      ...
      <div style={{ textAlign: "right", maxWidth: "60%" }}>
        {isHighlight ? (
          ...
          <Text strong style={{ color: "#334155", wordBreak: "break-word" }}>
            {value}
          </Text>
        )}
      </div>
      ...
      {loading ? (
        ...
        <div>
          ...
          >
            ...
            <Title
              level={1}
              style={{ margin: "16px 0", color: "#16a34a", fontSize: "36px" }}
            >
              {detail.transactionInfo?.amount
                ? detail.transactionInfo.amount.toLocaleString()
                : 0}{" "}
              <span style={{ fontSize: "24px" }}>VNĐ</span>
            </Title>
            <div>{getStatusTag(detail.transactionInfo?.paymentStatus)}</div>
          </div>
            ...
            <Row gutter={48}>
              ...
              <Col xs={24} md={12}>
                <div style={{ marginBottom: "32px" }}>
                  ...
                  >
                    <CreditCardOutlined style={{ color: "#3b82f6" }} /> Chi tiết
                    thanh toán
                  </Title>
                  ...
                  <InfoRow
                    ...
                    label="Mã giao dịch"
                    value={detail.transactionInfo?.transactionCode || "N/A"}
                  />
                  <InfoRow
                  ...
                  <InfoRow
                    icon={<BankOutlined />}
                    label="Nội dung CK"
                    value={`EDUFLOW ${detail.transactionInfo?.transactionCode || "PAYMENT"} ${detail.studentInfo?.studentId || "1"}`}
                    isHighlight
                  />
                </div>
                ...
                <div>
                  ...
                  >
                    <BookOutlined style={{ color: "#8b5cf6" }} /> Thông tin khóa
                    học
                  </Title>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      {detail.courseInfo?.title || "N/A"}
                    </Text>
                    <Text type="secondary" style={{ color: "#7c3aed" }}>
                      Mã khóa học: #{detail.courseInfo?.courseId || "N/A"}
                    </Text>
                  </div>
                </div>
              </Col>
              ...
              <Col xs={24} md={12}>
                <div style={{ marginBottom: "32px" }}>
                  ...
                  >
                    <UserOutlined style={{ color: "#f59e0b" }} /> Thông tin
                    khách hàng
                  </Title>
                ...
                <div style={{ marginBottom: "32px" }}>
                  ...
                  >
                    <BankOutlined style={{ color: "#10b981" }} /> Tài khoản thụ
                    hưởng
                  </Title>
                  <div
                    style={{
                ...
                <div>
                  ...
                  >
                    <FileImageOutlined style={{ color: "#ec4899" }} /> Ảnh hóa
                    đơn (Bill)
                  </Title>
                  ...
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      justifyContent: "center",
                      cursor: detail.transactionInfo?.billImageUrl
                        ? "pointer"
                        : "default",
                      transition: "all 0.3s",
                      overflow: "hidden",
                    ...
                    {detail.transactionInfo?.billImageUrl ? (
                      <img
                        onError={(e) => {
                          ...
                          e.target.src =
                            "https://via.placeholder.com/300?text=No+Bill+Image";
                        }}
